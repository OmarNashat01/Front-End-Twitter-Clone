...
import ToolTipCSS from "../Widgetbar/ToolTip/ToolTip.module.css";
...
function PostTooltip(
    ...
    return (
        <div className={ToolTipCSS.tooltip} style={{ marginRight: "-1%", marginLeft: "-2%" }} >
            <IconButton className={ToolTipCSS.tooltip__icon} onClick={navProfile}>
                <Avatar src={img} style={{ width: "25px", height: "25px" }} />
            </IconButton>

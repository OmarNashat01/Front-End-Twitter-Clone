...
<div className="container-fluid">
  <div className="row vh-100 ">
    ...
    <div className={RetweetsStatsStyle.borderStyle}>
            <div className={RetweetsStatsStyle.textStyle}>Number of New Accounts</div>
            <div>
            ...
            {!valuesLoading && <div><div className={RetweetsStatsStyle.chart}><VerticalBarChart startDate={startDate} endDate={endDate} values={chartValues} labels={chartLabels} /></div>
            
           <div  className={RetweetsStatsStyle.retweetCard}> <Card title="New Accounts" value={sumWithInitial} type="4" /></div>
            </div>}

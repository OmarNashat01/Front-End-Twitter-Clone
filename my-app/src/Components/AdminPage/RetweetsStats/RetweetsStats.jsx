...
import { getReTweetCount } from "../../../Api/admin";
        ...
        <div>
            <div className={AdminPageStyle.pageColor}>
                ...
                <div className={`container-fluid `}>
                    <div className={`row vh-100   ${RetweetsStatsStyle.widthSmall}`} >
                        <div className={`col col-lg-2 col-md-3 col-sm-1 col-sm-1 ${RetweetsStatsStyle.navBorder}  `}>
                            <div className={`sticky-top ${RetweetsStatsStyle.barWidth}  `} >

                                <Sidebar />
                            </div>
                        </div>
                        <div className={`col col-lg-10 col-md-9 col-sm-4 col-sm-4 ${RetweetsStatsStyle.borderStyle}`}>
                            ...
                            <div >
                                ...
                                <div >
                                    ...
                                    <button className={`btn btn-outline-primary ${RetweetsStatsStyle.buttonStyle} ${RetweetsStatsStyle.buttonPosition}`} type="submit" onClick={buttonHandler}>Show Chart</button>
                                </div>

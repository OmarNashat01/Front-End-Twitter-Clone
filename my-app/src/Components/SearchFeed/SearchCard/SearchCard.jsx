...
function SearchCard({
    ...
    following= 5105,
    verified=true,
    bio="”from strangers to someone i can't stop thinking about. from strangers to someone that meant the world to me.” —KathNiel",
}) {
  return (
        <div className={SearchCardCSS.searchcard}>
            ...
            <div className={SearchCardCSS.middlepart}>
                ...
                <div className={SearchCardCSS.bio__container}>
                <p>{bio}</p>
            </div>
            </div>

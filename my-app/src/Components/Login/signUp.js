    ...
    <div className="signUp">
      <div className="popup-inner">
        ...
        <div id="">
          ...
          <input
            className="inputTxt signupButton nameArea"
            id="userFullName"
            type={"text"}
            placeholder="Name"
          ></input>
          <input
            className="inputTxt signupButton"
            id="phoneOrEmail"
            type={"text"}
          ...
          <button
            type="button"
            className="updatedBtn btn btn-light update-ptn signupPutton"
            onClick={() => triggerInputs()}
          >
            Next
          </button>
        </div>

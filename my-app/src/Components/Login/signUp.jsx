...
function SignUp(props) {
  ...
  const PageDisplay = () => {
    return (
      <div className={Popup.FirstSignupPopup}>
        <button
          type="button"
          className="btn-close btn-close-black close-btn"
          id={Popup.closeBtn}
          aria-label="close"
          onClick={() => {
            window.open("/", "_self");
        ...
        <div className="form-floating mb-3">
          <input
            type={"text"}
            className="inputTxt form-control inputTxt signupButton nameArea"
        ...
        <select
          className={(Popup.datePicker, Popup.month)}
          id="selectedMonth"
          onChange={getUserData}
          name="temp_Month"
        >
        ...
        <select
          className={(Popup.datePicker, Popup.day)}
          id="selectedDay"
          onChange={getUserData}
          name="temp_Day"
        >
        ...
        <select
          className={(Popup.datePicker, Popup.year)}
          id="selectedYear"
          onChange={getUserData}
          name="temp_Year"
        >
  ...
  const secondStep = () => {
    return (
      <div className={Popup.secondSignupPopup}>
        <div>
          <button
            type="button"
            className="btn-close btn-close-black close-btn"
        ...
        <div className={Popup.privacyAndPolicy}>
      ...
      <div className={Popup.FirstSignupPopup}>
        ...
        <div className="form-floating mb-3">
          <input
            ...
            className="inputTxt form-control signupButton nameArea"
            id={("floatingInput phoneOrEmail", Popup.txtArea)}
            value={user.Month + " " + user.Day + ", " + user.Year}
            disabled={true}
  ...
  const passwordStep = () => {
    return (
      <div className={Popup.FirstSignupPopup}>
        ...
        <div className={Popup.txtAskPassword}>
          Make sure it's 8 cahracters or more.
        </div>
          ...
          <div>
            <div className="form-floating mb-3">
              <input
                ...
                className="inputTxt form-control inputTxt signupButton"
                id={("floatingInput", Popup.txtArea)}
  ...
  return (
    <div className={Popup.signUp}>
      <div className={Popup.popupInner}>
        ...
        <button
          type="button"
          className="updatedBtn btn btn-light update-ptn"
          id={(LoginCss.updatedBtn, Popup.signuputton)}

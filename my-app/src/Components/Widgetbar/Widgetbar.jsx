  ...
  return (
    <div  className={WidgetbarCSS.widget__divider}>
        <div className={WidgetbarCSS.widget__padding}>
            ...
            <FollowCard name="Amir Karara" tag="@Karara" img="https://see.news/wp-content/uploads/2021/07/19_2019-637093272003036987-303.jpg" about="Egyptian Actor" followers='80501' following='51400'/>
            ...
            <FollowCard name="Ahmed Helmy" tag="@Helmy" img="https://www.celebrityborn.com/admin/assets/images/people/ZDfuIt5OmHZUcDB06wYp_2017_11_19.jpg" about="Fanan" followers='12540' following='96000'/> 
...
@tourncure
 Ambassador in the Middle East." followers='50040' following='7000'/> 
            <FollowCard name="Abo Hashima" tag="@Hashima" img="https://www.celebrityborn.com/admin/assets/images/people/ahmed_abou_hashima_316.jpg" about="WORK HARD" followers='952300' following='432'/>  
